...
import dealTracker.DealTrackerManager;

import java.util.Scanner;

public class Main {

	private static final String DEFAULT_DEAL_FOLDER = "D:\\BridgeLabz-Training\\java-collections-practice\\scenario-based-codebase\\src\\main\\java\\dealTracker";
