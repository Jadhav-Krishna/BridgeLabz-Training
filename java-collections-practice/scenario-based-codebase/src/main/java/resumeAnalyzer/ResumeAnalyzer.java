...
public class ResumeAnalyzer {
    ...
    private Map<String, Resume> candidates = new HashMap<>();
    ...
    private void processResume(File file) throws IOException {
        ...
        Resume resume = new Resume(name, email, phone, foundSkills);
    ...
    public List<Resume> getSortedCandidates() {
        List<Resume> list = new ArrayList<>(candidates.values());
        list.sort((a, b) -> Integer.compare(b.getKeywordMatchCount(), a.getKeywordMatchCount()));
        return list;
    }

    public void displayAllCandidates() {
        List<Resume> list = getSortedCandidates();
        for (Resume r : list) {
